...
public class ComposerData {
    ...
    public ComposerData() {
        ...
        composers.put("1", new Composer("1", "TOYOTA", "COROLLA", "ca","5000-6999","TR47","TOY44G","GQ4-297","HYQ14AEM","CARD CC307","TOY43"));
        composers.put("2", new Composer("2", "Ford", "Bronco", "ca","1000-2999","this","is","a"," sample","for","ford"));
